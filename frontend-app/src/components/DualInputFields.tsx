    ...
    <div className="mb-2 flex w-full max-w-md">
      <div className="flex-1">
        <input
          ...
          className="w-full rounded-l-lg border-y border-l px-4 py-2 outline-none"
          placeholder="Title"
        />
      </div>
      <div className="relative flex-1">
        <input
          ...
          value={keyword}
          onChange={(e) => handleInputChange(index, e)}
          className="w-full rounded-r-lg border-y border-r px-4 py-2  outline-none"
          placeholder="Keyword"
        />
        <button
